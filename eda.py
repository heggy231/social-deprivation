...
#    tfidf2=tf2.fit_transform(meta.text.values)
    ...
    to_drop = [
        ...
        'WPS',
        'text1',
        'year1']  # WPS has many outlires in it and does not seem reliable
...
# plot_roc(truncatedFeatures,y,LogisticRegression)#does not do well with
# truncated features
    plot_roc(truncatedFeatures, y, RandomForestClassifier,
             n_estimators=1000)  # does well with 4 features
